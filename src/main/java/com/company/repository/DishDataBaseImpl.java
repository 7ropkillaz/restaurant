...
public class DishDataBaseImpl implements DishRepository {
    ...
    String user;
    String pass;
    public DishDataBaseImpl(String url, String user, String pass){
        this.url=url;
        this.user=user;
        this.pass=pass;
    }
    ...
    public void add(Dish dish){
        try (Connection connection =  DriverManager.getConnection(url, user, pass)){
            String sql = "INSERT INTO dishes (\"Id\", \"DishName\", \"Price\", \"Category\") VALUES (?,?,?,?)";
    ...
    public void edit(int id, Dish dish){
        try (Connection connection = DriverManager.getConnection(url, user, pass)){
            String sql = "UPDATE dishes SET \"DishName\" = ?,\"Price\" = ?, \"Category\" = ? WHERE \"Id\" = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
